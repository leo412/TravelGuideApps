...
//Searchiong for path when click on marker
    ...
    public List<List<LinkedHashMap<String,String>>> parse(JSONObject jObject){
        ...
        try {
            Log.d("ParserTaskjObject","UHHUM");

            Log.d("ParserTaskjObject",jObject.toString());

            jRoutes = jObject.getJSONArray("routes");
            Log.d("ParserTask","Is shit being done"+jObject);
...
Log.d( "TAG","THIS IS RUNNING DirectionFecther");
